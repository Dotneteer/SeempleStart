...
(function (Core) {
    ...
    function initCommonDirectives() {
        Main.appModule
            .directive('noClick', [function () { return new NoClickDirective(); }])
            .directive('pagination', [function () { return new PaginationDirective(); }])
            .directive('required', [function () { return new RequiredDirective(); }])
            .directive('matches', [function () { return new MatchesWidthDirective(); }])
            .directive('maxlen', [function () { return new LengthRangeDirective(); }])
            .directive('minlen', [function () { return new LengthRangeDirective(); }]);
    }
