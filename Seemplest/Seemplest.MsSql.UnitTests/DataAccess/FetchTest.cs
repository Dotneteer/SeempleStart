...
namespace Seemplest.MsSql.UnitTests.DataAccess
{
    ...
    public class FetchTest
    {
        ...
        public void QueryhWorksAsExpected()
        {
            ...
            // --- Act
            var rows = db.Query<SampleRecord>("select Id, Name from sample order by Id").ToList();
        ...
        public void FetchWorksWithMissingClrField()
        {
            ...
            // --- Act
            var rows = db.Fetch<SampleRecordWithMissingField>("select Id, Name from sample order by Name");
        ...
        public void FetchWorksWithMissingDataField()
        {
            ...
            // --- Act
            var rows = db.Fetch<SampleRecordWithExtraField>("select Id, Name from sample order by Id");
        ...
        public void FetchWorksWithNarrowingConversion()
        {
            ...
            // --- Act
            var rows = db.Fetch<SampleRecordWithNarrowingConversion>("select Id, Name from sample order by Id");
        ...
        public void FetchWorksWithWideningConversion()
        {
            ...
            // --- Act
            var rows = db.Fetch<SampleRecordWithWideningConversion>("select Id, Name from sample order by Id");
        ...
        public void FetchWorksWithTypeConversion()
        {
            ...
            // --- Act
            var rows = db.Fetch<SampleRecordWithTypeConversion>("select Id, Name from sample order by Id");
        ...
        public void FetchWorksWithNonIntegerBasedEnumValues()
        {
            // --- Arrange
            var db = new SqlDatabase(DB_CONN);
            db.Execute(@"create table sample(Id smallint not null, Name varchar(50) null)");
            db.Execute("insert into sample values(1, 'First')");
            db.Execute("insert into sample values(2, 'Second')");
        ...
        public void FetchWorksWithEnumStringValues()
        {
            // --- Arrange
            var db = new SqlDatabase(DB_CONN);
            db.Execute(@"create table sample(Id varchar(20) not null, Name varchar(50) null)");
            db.Execute("insert into sample values('Binary', 'First')");
            db.Execute("insert into sample values('Bit', 'Second')");
        ...
        public void InvalidMappingRaisesAnException()
        {
            // --- Arrange
            var db = new SqlDatabase(DB_CONN);
            db.Execute(@"create table sample(Id bit not null, Name varchar(50) null)");
            db.Execute("insert into sample values(0, 'First')");
            db.Execute("insert into sample values(1, 'Second')");

            // --- Act
            db.Fetch<SampleRecordWithEnum>("order by Id");
        }
        ...
        public void FirstIntoWorksAsExpected()
        {
            ...
            var row2 = db.FirstInto(instance, SqlExpression.CreateFrom("select Name from sample order by Id"));
        ...
        public void FirstOrDefaultWorksAsExpected()
        {
            ...
            var row2 = db.FirstOrDefault<SampleRecord>(SqlExpression.CreateFrom("select * from sample order by Id"));
            var row3 = db.FirstOrDefault<SampleRecord>("where Id = 3");
            var row4 = db.FirstOrDefault<SampleRecord>(SqlExpression.CreateFrom("select * from sample where Id = 3"));
        ...
        public void SingleWorksAsExpected()
        {
            ...
            var row2 = db.Single<SampleRecord>(new SqlExpression("select Id, Name from sample where Id = 2"));
        ...
        public void SingleIntoWorksAsExpected()
        {
            ...
            var row2 = db.SingleInto(instance, SqlExpression.CreateFrom("select Name from sample where Id = 1"));
