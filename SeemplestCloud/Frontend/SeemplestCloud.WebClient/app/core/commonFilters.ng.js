...
(function (Core) {
    ...
    */
    function initCommonFilters() {
        Main.appModule.filter('zeroAsEmpty', [zeroAsEmpty]).filter('dateAsString', [dateAsStringFilter]).filter('longText', [longTextFilter]);
    }
...
//# sourceMappingURL=commonFilters.ng.js.map
