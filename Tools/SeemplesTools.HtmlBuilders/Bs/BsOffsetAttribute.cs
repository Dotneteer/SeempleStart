...
{
    /// <summary>
    /// This attribute can be used as data annotation to specify the control offset of
    /// the corresponding property
    /// </summary>
    public class BsOffsetAttribute: Attribute, IMetadataAware
    {
        /// <summary>
